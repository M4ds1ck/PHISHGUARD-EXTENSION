// utils.js - v3.0.0 Optimized & Secure
const PhishGuardUtils = {
  ...
  isShortener: function(hostname) {
    const shorteners = new Set([
      ...
      'x.co', 'prettylinkpro.com', 'scrnch.me', 'filoops.info', 'vurl.com',
      '2.gp', 'twitthis.com', 'htxt.it', 'budurl.com', 'short.ie',
      'win.gs', 'atu.ca', 'rb.gy'
    ]);
...
console.log("[Utils] PhishGuard Utils v3.0.0 loaded & optimized");